    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:grid-rows-3 gap-6 auto-rows-fr">
        ...
        <div className="p-6 rounded-2xl shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col justify-center">
          ...
          <button className="mt-4 w-full bg-white text-blue-600 py-2 rounded-lg shadow hover:bg-blue-50">
            Open Assistant
          </button>
        </div>
        ...
        <div className="p-6 rounded-2xl shadow-lg bg-gradient-to-br from-teal-50 to-teal-100 flex flex-col justify-center">
          ...
          <button className="mt-4 w-full bg-white text-teal-600 py-2 rounded-lg shadow hover:bg-teal-50">
            Configure Wi-Fi
          </button>
        </div>
        ...
        <div className="p-6 rounded-2xl shadow-lg bg-gradient-to-br from-purple-50 to-purple-100 flex flex-col justify-center">
          ...
          <a href="https://drive.google.com/drive/folders/1CBMhXttqoCN8xnErzPDrqLj0zizn5HrR?usp=sharing">
            <button className="mt-4 w-full bg-white text-purple-600 py-2 rounded-lg shadow hover:shadow-md hover:text-purple-700 hover:cursor-pointer transition duration-200">
              Open Files
            </button>
          </a>
        </div>
        ...
        <div className="p-6 rounded-2xl shadow-lg bg-gradient-to-br from-amber-50 to-amber-100 flex flex-col justify-center">
          ...
          <button className="mt-4 w-full bg-white text-amber-600 py-2 rounded-lg shadow hover:bg-amber-50">
            Open Expenses
          </button>
        </div>
